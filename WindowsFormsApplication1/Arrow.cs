...
namespace GraphicsEditor
{
    class Arrow : Figure
    {
        ...
        //конструктор
        public Arrow(Point e, Color color)
        {
            VertexList = new List<PointF>();
            Centr = e;
            VertexList.Add(new Point() { X = e.X - 70, Y = e.Y });
            VertexList.Add(new Point() { X = e.X - 30, Y = e.Y - 40 });
            VertexList.Add(new Point() { X = e.X - 30, Y = e.Y - 20 });
            VertexList.Add(new Point() { X = e.X + 30, Y = e.Y - 20 });
            VertexList.Add(new Point() { X = e.X + 30, Y = e.Y - 40 });
            VertexList.Add(new Point() { X = e.X + 70, Y = e.Y });
            VertexList.Add(new Point() { X = e.X + 30, Y = e.Y + 40 });
